    ...
    dt_donation = $('#dt-donation').DataTable({
        ...
        columns : [{
            ...
            "render" : function (data, type, row) {
                ...
                html += '<button type="button" class="details-control btn btn-info" value="' + data+'+'+(row['total']+row['random'])+ '" onclick="confirmation(this);" '+disabled+'><i class="fa fa-pencil-square-o"></i> detail</button>';
