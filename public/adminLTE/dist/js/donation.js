...
function donation(){
    ...
    dt_donation = $('#dt-donation').DataTable({
        ...
        columns : [{
            ...
            "render" : function (data, type, row) {
                ...
                html += '<button type="button" class="details-control btn btn-info"><i class="fa fa-pencil-square-o"></i> detail</button>';
    ...
    var detailRows = [];
    $('#dt-donation tbody').on( 'click', 'tr td.details-control, tr td.btn-group .details-control', function () {
